...
public final class DateCalculator {
    ...
    /**
     * Construct DateCalculator Class @param year @param month @param day @param totalDay
     */
    ...
    /**
     * Calculate days for given month and year @param tMonth @param tYear @return days of a given month of given year
     */
    public static int MonthsToDays(int tMonth, int tYear) {
        if (tMonth == 1 || tMonth == 3 || tMonth == 5 || tMonth == 7 || tMonth == 8 || tMonth == 10 || tMonth == 12)
            return 31;
        else if (tMonth == 2) if (tYear % 4 == 0) return 29;
        else return 28;
        else return 30;
    }

    /**
     * Calculate Age in years, months and days and total days @param startDate @param endDate @return DateCalculator
     */
    public static DateCalculator calculateAge(Calendar startDate, Calendar endDate) {
        ...
        if (mDayDiff < 0) if (mMonDiff > 0) {
            ...
            mDayDiff = mDayDiff + MonthsToDays(tMonth - 1, tYear);
            ;
        }/*String age = "Age: " + mYearDiff + " Years " + mMonDiff + " Months " + mDayDiff + " Days"; System.out.println(age);*/
